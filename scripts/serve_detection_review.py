...
<p class="hint">Drag inside a box to move it. Drag a corner to resize. Turn on <em>Add-box mode</em> to draw a new box anywhere, even over an existing box; holding <kbd>Shift</kbd> also adds one box temporarily. Click a list item to select it. <kbd>Delete</kbd> removes the selected box.</p>
</aside></main>
<script>
const api = '/api/'; let allItems=[], visibleItems=[], pos=0, current=null, boxes=[], selected=-1, image=new Image(), draw=null, interaction=null, addMode=false;
